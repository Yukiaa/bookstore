...
func (x *ListBooksReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListBooksReponse) ProtoMessage() {}

func (x *ListBooksReponse) ProtoReflect() protoreflect.Message {
	mi := &file_bookstore_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListBooksReponse.ProtoReflect.Descriptor instead.
func (*ListBooksReponse) Descriptor() ([]byte, []int) {
	return file_bookstore_proto_rawDescGZIP(), []int{7}
}

func (x *ListBooksReponse) GetBook() []*Book {
	if x != nil {
		return x.Book
	}
	return nil
...
func (x *ListBooksReponse) GetNextPageToken() string {
	if x != nil {
...
const file_bookstore_proto_rawDesc = "" +
	...
	"\tListBooks\x12\x1b.bookstore.ListBooksRequest\x1a\x1b.bookstore.ListBooksReponse\"!\x82\xd3\xe4\x93\x02\x1b\x12\x19/v1/shelves/{shelf}/booksB\x0eZ\fbookstore/pbb\x06proto3"
...
var file_bookstore_proto_goTypes = []any{
	...
	(*ListBooksReponse)(nil),    // 7: bookstore.ListBooksReponse
...
var file_bookstore_proto_depIdxs = []int32{
	...
	1, // 2: bookstore.ListBooksReponse.book:type_name -> bookstore.Book
	8, // 3: bookstore.Bookstore.ListShelves:input_type -> google.protobuf.Empty
	...
	2, // 8: bookstore.Bookstore.ListShelves:output_type -> bookstore.ListShelvesResponse
	0, // 9: bookstore.Bookstore.CreateShelf:output_type -> bookstore.Shelf
	0, // 10: bookstore.Bookstore.GetShelf:output_type -> bookstore.Shelf
	8, // 11: bookstore.Bookstore.DeleteShelf:output_type -> google.protobuf.Empty
	7, // 12: bookstore.Bookstore.ListBooks:output_type -> bookstore.ListBooksReponse
