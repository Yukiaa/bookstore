...
type BookstoreClient interface {
	...
	// 返回书架上的图书列表
	ListBooks(ctx context.Context, in *ListBooksRequest, opts ...grpc.CallOption) (*ListBooksReponse, error)
}
...
func (c *bookstoreClient) ListBooks(ctx context.Context, in *ListBooksRequest, opts ...grpc.CallOption) (*ListBooksReponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListBooksReponse)
...
type BookstoreServer interface {
	...
	// 返回书架上的图书列表
	ListBooks(context.Context, *ListBooksRequest) (*ListBooksReponse, error)
...
func (UnimplementedBookstoreServer) ListBooks(context.Context, *ListBooksRequest) (*ListBooksReponse, error) {
